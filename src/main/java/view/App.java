...
public class App extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        leftPane1.setBackground(new java.awt.Color(51, 51, 51));
        ...
        leftPane2.setBackground(new java.awt.Color(51, 51, 51));
        leftPane2.setPreferredSize(new java.awt.Dimension(200, 590));

        divisasBtn.setBackground(new java.awt.Color(102, 102, 102));
        ...
        tempBtn.setBackground(new java.awt.Color(102, 102, 102));
        ...
        distBtn.setBackground(new java.awt.Color(102, 102, 102));
        ...
        pesoBtn.setBackground(new java.awt.Color(102, 102, 102));
